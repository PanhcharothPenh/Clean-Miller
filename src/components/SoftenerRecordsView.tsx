                  ...
                  <table className="w-full border-collapse border border-slate-350">
                    <thead>
                      <tr className="bg-sky-600 text-white text-[11px] font-bold border-b border-sky-700">
                        <th rowSpan={2} className="py-2.5 px-2 border-r border-sky-500 text-center w-[100px] font-black">
                          📅 {lang === 'en' ? 'Date' : 'ថ្ងៃ'}
                        </th>
                        <th rowSpan={2} className="py-2.5 px-1 border-r border-sky-500 text-center w-[75px] font-black">
                          🛢️ {lang === 'en' ? 'Stock In' : 'ចូល'}
                        </th>
                      ...
                      <tr className="bg-sky-500 text-white text-[10px] font-bold border-b border-sky-600">
                        <th className="py-1 px-1 border-r border-sky-400 text-center w-[65px] font-bold">Comfort</th>
                        <th className="py-1 px-1 border-r border-sky-400 text-center w-[65px] font-bold">Ora</th>
                        <th className="py-1 px-1 border-r border-sky-400 text-center w-[65px] font-bold">Siusip</th>
                      </tr>
                    </thead>
                    <tbody className="text-[10px] text-slate-800 font-mono divide-y divide-slate-355">
                      {localRows.map((r, i) => (
                        <tr key={i} className="hover:bg-slate-50/50 odd:bg-white even:bg-slate-50/20" style={{ height: '17px' }}>
                          ...
                          <td className="py-1.5 px-1 text-center border-r border-slate-355 font-bold text-sky-900 bg-sky-50/10">
                          ...
                          <td className="py-1.5 px-3 text-left border-r border-slate-355 font-sans text-slate-600 text-[9px] truncate max-w-[150px]">
                            {r.note || ''}
                          </td>
                      ...
                      <tr className="bg-sky-600 text-white font-extrabold text-[11px] border-t-2 border-sky-700">
                        ...
                        <td className="py-2.5 px-1 text-center border-r border-sky-500 bg-sky-700 font-extrabold">{sumComfort}</td>
                        <td className="py-2.5 px-1 text-center border-r border-sky-500 bg-sky-700 font-extrabold">{sumOra}</td>
                        <td className="py-2.5 px-1 text-center border-r border-sky-500 bg-sky-700 font-extrabold">{sumSiusip}</td>
